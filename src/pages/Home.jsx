    ...
    return (
        <>
            <Navbar
                ...
                scrollToBrowse={() => { scrollToSection(browseRef); }}
                scrollToWorks={() => { scrollToSection(howItWorksRef); }}
            ...
            <section ref={browseRef} className='browse-events' style={browseEvents}>
                <BrowseEventsHead title="What's Happening Near You" view='View all' />
                <BrowseEventsFilter filterEvent={{ backgroundColor: 'rgb(234, 238, 246)' }} />
            ...
            <section style={section} ref={howItWorksRef}>
                <HowItWorks />
            </section>
            ...
            <section style={section} ref={contactRef}>
                <Footer />
            </section>
        </>
    );
