    ...
    return (
        <div>
            <div style={{ backgroundColor: 'rgb(37,43,78)', padding: '5em 10em' }} className='host-events d-flex align-items-center justify-content-between text-white gap-5'>
                ...
                <button onClick={onStartFree} style={{fontSize:'1.1em'}} className='btn btn-light fw-semibold text-primary px-4 py-2'>Start For Free <i className="bi bi-arrow-right"></i></button>
            </div>
        </div>
    );
};
