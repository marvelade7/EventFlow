                ...
                <div id="carouselExampleSlidesOnly" className="carousel slide text-white" data-bs-ride="carousel">
                    <div data-aos="fade-up" className="hero-section carousel-fixed-content d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div className='btns mt-3 d-flex align-items-center gap-4'>
                            <button onClick={onCreateEvent} data-aos="fade-right" style={{fontSize: '1.1em', padding: '8px 30px'}} className='hero-btn btn btn-warning text-dark w-auto fw-semibold '>Get Started</button>
                            <button onClick={onBrowseEvents} data-aos="fade-left" style={{fontSize: '1.1em', padding: '8px 24px'}} className='hero-btn btn btn-outline-light w-auto fw-semibold '>Browse Events</button>
                        </div>
                    </div>
