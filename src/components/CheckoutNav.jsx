...
const CheckoutNav = () => {
    return (
        <div className='d-flex align-items-center justify-content-center bg-white py-3 shadow-sm checkout-nav' style={{gap: '200px'}}>
            <Logo size='40px' fontSize='1.2em' />
            <div className='d-flex align-items-center checkout-steps' style={{gap: '50px'}}>
                <div className='d-flex align-items-center gap-3'>
                    ...
                    <p style={{ fontSize: '.9em', color: 'rgb(17,213,243)' }} className='m-0 fw-semibold'>Select Tickets</p>
                </div>
